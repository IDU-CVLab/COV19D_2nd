...
**With images processing (Optional).** Uppermost and lower most slcies of each CT scans were removed with 60% of each CT scan slcies is kept. Next, Slices of the CT scan were manually cropped to keep the Region of Interste (ROI), which is the two lung areas.  
